...
use freelanceBundle\Entity\Candidate;
use freelanceBundle\Form\CandidateType;
...
class CandidateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('freelanceBundle:Candidate')->findAll();

        return $this->render('freelanceBundle:Candidate:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('freelanceBundle:Candidate:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('freelanceBundle:Candidate')->find($id);
        ...
        return $this->render('freelanceBundle:Candidate:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('freelanceBundle:Candidate:edit.html.twig', array(
            'entity'      => $entity,
